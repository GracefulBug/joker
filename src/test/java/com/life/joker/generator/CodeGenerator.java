...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        String patentPath = "com.life";
        String moduleName = "joker";
        ...
        dsc.setUrl("jdbc:mysql://123.56.142.9:3306/joker?useSSL=false&serverTimezone=GMT%2B8&allowPublicKeyRetrieval=true");
